...
const ReviewItems = ({item,removeItem}) => {
        ...
        <div className='container bg-light col-md-8 mt-4 rounded d-flex justify-content-evenly align-items-center border border-warning'>
           ...
           <div className='d-flex w-100 align-items-center justify-content-between'>
                ...
                <div className='icon-container'>
                    <FontAwesomeIcon onClick={()=>removeItem(item.id)} id='custom-icon' className='text-danger fs-2 p-3' icon={faTrashAlt}></FontAwesomeIcon>
                </div>
           </div>
